                            ...
                            <div className="col-md-8 col-sm-12 col-12 recuitment-inner">
                                ...
                                <form className="recuitment-form">
                                    ...
                                    <div className="rec-submit" id="divsubmit">
                                        <button  type="button" id="btnxoa" className="btn-submit-recuitment" name="">
                                            <i className="fa fa-floppy-o pr-2"></i>Cập nhật trạng thái
                                        </button>
                                        <button type="button" id="btnluu" className="btn-submit-recuitment" name="">
